...
class InvalidClientTypeException(
    clientType: String,
) : MainException(HttpStatus.BAD_REQUEST, "지원하지 않는 client_type 입니다: $clientType")

class VersionNotFoundException(
    clientType: String,
) : MainException(HttpStatus.NOT_FOUND, "해당 client_type 의 버전 정보를 찾을 수 없습니다: $clientType")
