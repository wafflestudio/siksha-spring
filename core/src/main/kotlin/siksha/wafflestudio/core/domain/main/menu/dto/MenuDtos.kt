...
data class MenuInListDto @JsonCreator constructor(
...
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy::class)
data class RestaurantInListDto @JsonCreator constructor(
    @JsonProperty("created_at")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ssXXX", timezone = "UTC")
    val createdAt: OffsetDateTime,
    @JsonProperty("updated_at")
...
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy::class)
data class DateWithTypeInListDto @JsonCreator constructor(
    @JsonProperty("date")
...
// /menus 요청에 대한 전체 Dto
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy::class)
data class MenuListResponseDto @JsonCreator constructor(
    @JsonProperty("count")
    val count: Int,
    @JsonProperty("result")
...
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy::class)
data class MenuDetailsDto @JsonCreator constructor(
    @JsonProperty("created_at")
    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd'T'HH:mm:ssXXX", timezone = "UTC")
    val createdAt: OffsetDateTime,
    @JsonProperty("updated_at")
