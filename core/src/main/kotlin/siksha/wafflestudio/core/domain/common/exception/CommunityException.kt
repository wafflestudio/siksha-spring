...
sealed class CommunityException(
    httpStatus: HttpStatus,
    errorMessage: String,
) : SikshaException(httpStatus, errorMessage)

class InvalidBoardFormException(
    message: String,
) : CommunityException(HttpStatus.BAD_REQUEST, message)
...
class BoardSaveFailedException(
    message: String?,
) : CommunityException(HttpStatus.INTERNAL_SERVER_ERROR, "게시판 저장에 실패하였습니다 - $message")
